...
- **GET /api/products/search/{name}**: Mencari produk berdasarkan nama.
- **GET /api/products/below/{price}**: Mengambil produk dengan harga di bawah nilai tertentu.
## Contoh Data Request dan Response
### Contoh Request
- **POST /api/products**
 ```json
 {
